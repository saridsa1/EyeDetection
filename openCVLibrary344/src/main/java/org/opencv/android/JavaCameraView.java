        ...
        synchronized (this) {
            ...
            try {
                ...
                if (sizes != null) {
                     ...
                     * MODIFIED FROM ****************************************************************
                     */
                    Size frameSize = calculateCameraFrameSize(sizes, new JavaCameraSizeAccessor(), width, height); // original
                     ...
                     * MODIFIED FROM ****************************************************************
                     */
                        mScale = Math.min(((float)height)/mFrameHeight, ((float)width)/mFrameWidth); // original
                    ...
                    if (mFpsMeter != null) {
                         ...
                         * MODIFIED FROM ****************************************************************
                         */
                        mFpsMeter.setResolution(mFrameWidth, mFrameHeight); // original
